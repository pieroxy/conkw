...
public class Runner {
    public static void main(String[] args) throws Exception {
        if (!ConfigReader.exists() || hasForceReinstall(args)) {
            new Installer().run();
        }
    ...
    private static boolean hasForceReinstall(String[] args) {
        for(String s : args) if (s.equals("--force-reinstall")) return true;
        return false;
    }
}

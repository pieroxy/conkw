...
public abstract class Grabber {
  ...
  public void initConfig(File homeDir, Map<String, Object> config) throws IOException {
  ...
  protected void setNameFromConfig(Map<String, Object> config, String defaultValue) {

package net.pieroxy.conkw.grabbers.procgrabber;

import net.pieroxy.conkw.grabbers.AsyncGrabber;
import net.pieroxy.conkw.PerformanceTools;
...
public class ProcGrabber extends AsyncGrabber {
  ...
  public void setConfig(Map<String, Object> config){
    ...
    blockDevices = (Collection<String>) config.get("blockDevices");
    if (blockDevices == null) {
      blockDevices = new ArrayList<>();
      blockDevices.add("sda");
    }
    mountPoints = (List<String>) config.get("mountPoints");
    if (mountPoints == null) {
